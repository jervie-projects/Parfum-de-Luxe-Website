...
<div class="container my-md-5 pt-md-5">
    <div class="row text-center text-md-start">
        <div class="col-12 col-md-5 mb-3 mb-md-0">
            <h1 class="fst-italic fw-bold text-center" style="font-family:Parisienne;">Creed</h1>
        </div>
...
<div class="items mt-5">
    <div class="container">
        <div class="row">
        	...
        	foreach ($creed as $creed) {
        	?>
        	<div class="col-lg-3 mb-4 text-center">
        <div class="product-entry border h-100 d-flex flex-column">
          <a href="<?php $this->url();?>perfume/<?php echo $creed["perfume_id"]; ?>">
            <img src="<?php echo $creed["perfume_image"];?>" class="img-fluid" alt="<?php echo $creed["perfume_name"];?>">
          </a>
          <div class="desc mt-auto">
            <h2 class="text-black text-decoration-none"><?php echo $creed["perfume_name"];?></h2>
          </div>
        </div>
      </div>
           	<?php 
